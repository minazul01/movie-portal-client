  ...
  return (
    <div className="boxShadow px-10 w-full lg:flex-row gap-[30px] lg:gap-0 flex-col flex items-center justify-evenly py-20 rounded-xl">
      ...
      <div className="w-full lg:w-[30%] text-center lg:text-start">
        ...
        <h3 className="text-[#8093B8] text-[2rem] sm:text-[3.2rem]">
          {error.statusText}
        </h3>

        <Link to="/">
          <button className="py-3 px-6 sm:px-8 text-[0.9rem] sm:text-[1rem] rounded-full bg-[#566FA7] text-white mt-8 hover:bg-lime-300 cursor-pointer">
            Back to homepage
          </button>
        </Link>
      </div>
